...
public class Ghost : MonoBehaviour
{
    ...
    public int scatterModeTimer1 = 7; // Les timers des differents fantomes
    ...
    public enum Mode // les trois differents comportements des fantomes (poursuivre, s'eparpiller, effraye)
    {
        Chase,
        Scatter,
        Frightened
    ...
    void ModeUpdate() // met a jour le comportement du fantomes grace aux timers
    {
